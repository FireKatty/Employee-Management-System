...
const AdminDashboard = () => {
  ...
  const handleAddUser = async (event) => {
    ...
    try {
      const response = await fetch("https://mern-project-s3nb.onrender.com/api/data/create", {
        method: "POST",
        headers: {
  ...
  const fetchUsersFromDatabase = async () => {
    try {
      ...
      const response = await fetch("https://mern-project-s3nb.onrender.com/api/data/list", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          authorization: JSON.parse(localStorage.getItem('token'))
  ...
  const handleEditUser = async (event) => {
    ...
    try {
      const response = await fetch(`https://mern-project-s3nb.onrender.com/api/data/update/${editingUser.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: JSON.parse(localStorage.getItem('token'))
  ...
  const handleDeleteUser = async (id) => {
    try {
      ...
      const response = await fetch(`https://mern-project-s3nb.onrender.com/api/data/delete/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          authorization: JSON.parse(localStorage.getItem('token'))
  ...
  const toggleUserStatus = async (id) => {
    try {
      const response = await fetch(`https://mern-project-s3nb.onrender.com/api/data/toggleStatus/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: JSON.parse(localStorage.getItem('token'))
  ...
  const handleRoleChange = async (id, role) => {
    ...
    try {
      const response = await fetch(`https://mern-project-s3nb.onrender.com/api/data/editrole/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          authorization: JSON.parse(localStorage.getItem('token'))
